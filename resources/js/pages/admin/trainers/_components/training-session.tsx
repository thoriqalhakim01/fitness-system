...
import { Attendance, TrainingSession } from '@/types';
...
export default function TrainingSessionTable({ lists, attendances = [] }: Props) {
                        ...
                        <TableRow className="cursor-pointer hover:bg-muted/50">
                            ...
                            <TableCell>
                                <Button variant="ghost" size="sm" onClick={() => toggleSession(item.id)} className="h-8 w-8 p-0">
                                    {expandedSessions.has(item.id) ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
                                </Button>
                            </TableCell>
                        </TableRow>
